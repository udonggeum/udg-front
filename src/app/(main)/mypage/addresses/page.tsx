      ...
      <section className="container mx-auto px-4 py-10">
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center justify-between">
            ...
            <Button onClick={handleAddAddress} className="gap-2 bg-gray-900 hover:bg-gray-800">
              <Plus size={20} />
              배송지 추가
            </Button>
          </div>
        ...
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-20">
            ...
            <Button onClick={loadAddresses} className="mt-6 bg-gray-900 hover:bg-gray-800">
              다시 시도
            </Button>
          </div>
        ) : addresses.length === 0 ? (
              ...
              <div key={address.id} className="relative">
                ...
                {address.is_default && (
                  <div className="absolute -top-2 left-4 z-10">
                    <Badge className="gap-1 shadow-md bg-gray-900">
